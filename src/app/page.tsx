...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/smiling-pretty-young-woman-posing-camera_1262-18333.jpg",
          alt: "Smiling pretty young woman posing at camera",
        },
        {
        ...
        },
        {
          ...
          alt: "Happy woman in grey jacket laughing on brown background",
        },
        {
          ...
          alt: "Young handsome african american man posing outdoors",
        },
      ]}
      ...
      marqueeItems={[
        {
          type: "text",
          text: "No Hard Credit Checks",
        },
        {
          type: "text",
          text: "Zero Upfront Costs",
        },
        {
          type: "text",
          text: "Guaranteed Lower Rates",
        },
        {
          type: "text",
          text: "Fast Negotiation",
        },
        {
          type: "text",
          text: "Expert Support",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          date: "Nov 2024",
          title: "Homeowner",
          quote: "No upfront payments required, just instant savings on my recurring bills.",
          tag: "Trust",
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Is there a credit check?",
          content: "No, we do not perform hard credit checks for our comparison services.",
        },
        {
          id: "q2",
          title: "Do I have to pay upfront?",
          content: "No, our service requires zero upfront payments. You only benefit from the savings found.",
        },
        {
          id: "q3",
          title: "Which services do you compare?",
          content: "We cover internet, cable TV, home phone, cell plans, and home security systems.",
        },
      ]}
